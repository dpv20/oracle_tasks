...
T: dict[str, dict[str, str]] = {
    "en": {
        ...
        "spools.mode.apply_existing": "Apply existing",
        "spools.country": "Country",
        "spools.source_db": "Source DB",
        "spools.destination_db": "Destination DB",
        "spools.existing_spool": "Existing spool",
        "spools.browse_spool": "Browse...",
        "spools.select_spool_file": "Select spool file",
        ...
        "spools.run_apply_existing": "Apply existing",
        "spools.cancel": "Cancel",
        "spools.cancelling": "Cancelling...",
        "spools.cancel_requested": "Cancelling current work...",
        ...
        "spools.status_cancelled": "cancelled",
        ...
        "spools.summary_apply_existing": "Apply existing {ok}/{total} OK - {err} errors",
        "spools.summary_cancelled": "Cancelled - Extract {extract_ok}/{extract_total} OK - Inject {inject_ok}/{inject_total} OK",
        "spools.summary_apply_existing_cancelled": "Cancelled",
        "spools.detail_extract_apply": "Extracted + injected: {injected}\nOnly extracted: {only_extracted}\nNothing: {nothing}",
        "spools.detail_apply_existing": "Injected: {injected}\nNothing: {nothing}",
        "spools.open_folder": "Open spools folder",
        "spools.open_country_folder": "{country} spools folder",
        "spools.no_template": "No spool script for {country}. Add CL_ACCOUNT_SPOOL_{country}2.sql to spools/ first.",
        ...
        "spools.invalid_country": "Pick a country.",
        "spools.invalid_db": "Pick a source database.",
        "spools.invalid_destination_db": "Pick a destination database.",
        "spools.no_existing_spool": "Pick an existing .SQL spool first.",
        "spools.invalid_spool_file": "The selected file must be a .SQL file.",
        "spools.spool_file_missing": "Spool file not found: {file}",
        ...
        "spools.confirm_apply_existing": "You are about to apply this spool into:\n   {db}\n\nFile: {file}\n\nThis will modify destination data. Continue?",
    ...
    "es": {
        ...
        "spools.mode": "Modo",
        "spools.mode.extract": "Extract / Apply",
        "spools.mode.apply_existing": "Aplicar existente",
        "spools.country": "País",
        "spools.source_db": "DB origen",
        "spools.destination_db": "DB destino",
        "spools.existing_spool": "Spool existente",
        "spools.browse_spool": "Examinar...",
        "spools.select_spool_file": "Seleccionar spool",
        ...
        "spools.run_extract_only": "Extract",
        "spools.run_extract_apply": "Apply",
        "spools.run_apply_existing": "Aplicar existente",
        "spools.cancel": "Cancelar",
        "spools.cancelling": "Cancelando...",
        "spools.cancel_requested": "Cancelando trabajo actual...",
        ...
        "spools.status_cancelled": "cancelada",
        "spools.summary_ok": "{ok}/{total} OK",
        ...
        "spools.summary_apply_existing": "Aplicar existente {ok}/{total} OK - {err} con error",
        "spools.summary_cancelled": "Cancelado - Extract {extract_ok}/{extract_total} OK - Inject {inject_ok}/{inject_total} OK",
        "spools.summary_apply_existing_cancelled": "Cancelado",
        "spools.detail_extract_apply": "Extraídas + inyectadas: {injected}\nSolo extraídas: {only_extracted}\nNada: {nothing}",
        "spools.detail_apply_existing": "Inyectadas: {injected}\nNada: {nothing}",
        "spools.open_folder": "Abrir carpeta de spools",
        "spools.open_country_folder": "{country} spools folder",
        "spools.no_template": "No hay script de spool para {country}. Agrega CL_ACCOUNT_SPOOL_{country}2.sql en spools/ primero.",
        ...
        "spools.invalid_country": "Selecciona un país.",
        "spools.invalid_db": "Selecciona una DB origen.",
        "spools.invalid_destination_db": "Selecciona una DB destino.",
        "spools.no_existing_spool": "Selecciona primero un spool .SQL existente.",
        "spools.invalid_spool_file": "El archivo seleccionado debe ser .SQL.",
        "spools.spool_file_missing": "No se encontró el spool: {file}",
        ...
        "spools.confirm_apply_existing": "Vas a aplicar este spool en:\n   {db}\n\nArchivo: {file}\n\nEsto modificara datos en destino. Continuar?",
