...
- Generated/cached state (logs, spools_CL_out, spools_savings_out, downloaded SQLcl) lives in DATA_DIR
...
def ensure_dirs() -> None:
    ...
    for d in (CONFIG_DIR, DATA_DIR, SPOOLS_CL_OUT_DIR, SPOOLS_SAVINGS_OUT_DIR):
